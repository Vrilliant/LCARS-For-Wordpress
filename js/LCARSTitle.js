/* -----------------------------------------------------------------------------
	File Name: 		LCARSTitle.js
	Author: 		Brian Scott Gregory
	Date:			02/24/2014

	Description:	The LCARS Title object
					
	Arguments:		None 
----------------------------------------------------------------------------- */
function LCARSTitle( lcarsPage, x, y, width, height, align) {
	var that = this;
	var page = lcarsPage;
	var xVal = x, yVal = y, widthVal = width, heightVal = height;

	// Create a disassociated control, the only real quasi/unique value being the name
	var registeredControl = new LCARSControl( "LCARSTitle" );
